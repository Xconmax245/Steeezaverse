...
export const scaledStrokeWidth = (strokeWidth: number, size: number) => {
  return strokeWidth; // Simplified for scaling; SVG vector-effect handles scaling if needed, or we just pass strokeWidth directly
};
