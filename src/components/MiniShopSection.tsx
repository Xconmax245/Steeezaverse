...
export default async function MiniShopSection() {
  ...
  return (
    <section className="relative w-full bg-black py-12 md:py-16 overflow-hidden z-20">
      <div className="max-w-[95vw] mx-auto px-4 md:px-8">
        {/* Section Heading */}
        <h2
          className="font-chillax text-xs md:text-sm uppercase tracking-[0.3em] text-white/50 mb-6 md:mb-8"
          data-aos="fade-up"
